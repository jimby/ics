...
<!DOCTYPE HTML     PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
    ...
    <head>
        ...
        <title>ICS Customer Management</title>
...
<!-- show shipping to headers-->
        ...
        //loop left open   
           ?>
           <td>
	           <form name="editCustomer" action="editCustomer.php" method="GET">
        ...
        <form name="addCustomer" action="editCustomer.php">
            <input type="submit" value="Add Customer"/>
        </form>
        <form name="backToMainPage" action="../customer/findCustomer.php">
